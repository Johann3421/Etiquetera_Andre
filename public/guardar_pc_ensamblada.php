...
try {
    ...
    (fecha, usuario, gama, cpu, ram, storage, mb, gpu, psu, `case`, cantidad, observaciones, checklist_qa)
    VALUES (NOW(), :usuario, :gama, :cpu, :ram, :storage, :mb, :gpu, :psu, :case, :cantidad, :observaciones, :checklist_qa)");
